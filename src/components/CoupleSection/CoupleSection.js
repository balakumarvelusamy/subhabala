                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-lg-7">
                    <div className="couple-text">
                      <h3>BalaKumar</h3>
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Urna orci auctor vitae nisl. Erat fringilla pellentesque amet tempus. Commodo mi vitae, sed sagittis blandit. Leo netus magna fusce ac turpis mauris maecenas non.</p>
                      <div className="social">
                        <ul>
                          {/* <li><Link to="/"><i className="ti-facebook"></i></Link></li>
                                                    <li><Link to="/"><i className="ti-twitter-alt"></i></Link></li> */}
                          <li>
                            <Link to="https://www.instagram.com/subhaswethaa/">
                      ...
                      <div className="social">
                        <ul>
                          {/* <li><Link to="/"><i className="ti-facebook"></i></Link></li>
                                                    <li><Link to="/"><i className="ti-twitter-alt"></i></Link></li> */}
                          <li>
                            <Link to="https://www.instagram.com/theuniquecreations/">
                              <i className="ti-instagram"></i>
                            </Link>
                          </li>
                          {/* <li><Link to="/"><i className="ti-pinterest"></i></Link></li> */}
